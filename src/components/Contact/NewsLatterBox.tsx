		...
		<div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
			...
			<div>
				<input
					...
					className="border-stroke text-body-color focus:border-sub-theme dark:text-body-color-dark dark:shadow-two dark:focus:border-sub-theme mb-4 w-full rounded-xs border bg-[#f8f8f8] px-6 py-3 text-base outline-hidden dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
				/>
				<input
					type="email"
					name="email"
				...
				<input
					type="submit"
					value="Subscribe"
					className="bg-sub-theme shadow-submit hover:bg-sub-theme/90 dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-xs px-9 py-4 text-base font-medium text-white duration-300"
				/>
