	...
	return (
		<>
			<a
				...
				className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-xs bg-gray-light text-body-color duration-300 hover:bg-sub-theme hover:text-white dark:bg-gray-dark dark:hover:bg-sub-theme sm:ml-3"
			>
				<svg
					width="16"
					height="16"
			...
			<a
				href="#0"
				aria-label="social-share"
				className="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-xs bg-gray-light text-body-color duration-300 hover:bg-sub-theme hover:text-white dark:bg-gray-dark dark:hover:bg-sub-theme"
			>
				<svg
					width="18"
					height="18"
