					...
					<div className="flex flex-wrap -mx-4">
						<div className="w-full px-4">
							<div className="mx-auto max-w-[530px] text-center">
								...
								<Link
									href="/"
									className="px-8 py-3 text-base font-bold text-white duration-300 rounded-md bg-sub-theme shadow-signUp hover:bg-white hover:text-sub-theme md:px-9 lg:px-8 xl:px-9"
								>
									Back to Homepage
								</Link>
							</div>
