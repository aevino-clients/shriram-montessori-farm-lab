							...
							<div>
								...
								<div className="border-body-color/10 mb-10 flex flex-wrap items-center justify-between border-b pb-4 dark:border-white/10">
									...
									<div className="mb-5">
										<a
											href="#0"
											className="bg-sub-theme inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-semibold text-white"
										>
											Design
										</a>
									</div>
								...
								<div>
									...
									<p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
										...
										<strong className="text-sub-theme dark:text-white">
											{' '}
											malesuada{' '}
										</strong>
									...
									<p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
										...
										pellentesque nec.
										<span className="text-sub-theme underline dark:text-white">
											{' '}
									...
									<div className="bg-sub-theme/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
							...
							<div className="shadow-three dark:bg-gray-dark mt-12 mb-10 rounded-xs bg-white p-6 lg:mt-0 dark:shadow-none">
								<div className="flex items-center justify-between">
									<input
										...
										className="border-stroke dark:text-body-color-dark dark:shadow-two text-body-color focus:border-sub-theme dark:focus:border-sub-theme mr-4 w-full rounded-xs border bg-[#f8f8f8] px-6 py-3 text-base outline-hidden transition-all duration-300 dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
									/>
									<button
										aria-label="search button"
										className="bg-sub-theme flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xs text-white"
									>
										<svg
											width="20"
											height="18"
							...
							<div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
								...
								<ul className="px-8 py-6">
									<li>
										<a
											href="#0"
											className="text-body-color hover:text-sub-theme mb-3 inline-block text-base font-medium"
										>
											Tailwind Templates
										</a>
									</li>
